...
import type {RelationColumnRenderNode, RelationRenderNode} from '../boxed-model';
import {useBoxedEditorState, useListActions, useRelationActions} from '../BoxedEditorProvider';
                            ...
                            <TableRow>
                                ...
                                >
                                    {node.columns.map((column) => (
                                        <RelationColumnHeader key={column.id} node={node} column={column} />
                                    ))}
                                </SortableContext>
                                {!state.readOnly && (
                                    <TableCell

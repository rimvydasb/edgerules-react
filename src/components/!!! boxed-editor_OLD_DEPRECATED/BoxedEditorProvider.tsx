...
export interface FunctionActions {
    editSignature: (node: FunctionRenderNode | ExternalFunctionRenderNode) => void;
}
...
export interface RelationActions {
    editColumn: (node: RelationRenderNode, action: 'add' | 'delete', source?: string) => void;
    renameColumn: (node: RelationRenderNode, source: string, name: string) => void;
}
